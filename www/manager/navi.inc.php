...
<nav class="navbar-default navbar-static-side" role="navigation">
	<div class="sidebar-collapse">
		<ul class="nav metismenu" id="side-menu">
				...
				<div class="dropdown profile-element">
					...
					<ul class="dropdown-menu animated fadeInRight m-t-xs">
						<!--
                                ...
                                <li class="divider"></li>
								-->
						<li><a href="<?php echo G5_DBADMIN_ADMIN_URL ?>/logout.php?url=<?php echo urlencode(correct_goto_url("/" . G5_DBADMIN_ADMIN_DIR)); ?>">Logout</a></li>
					</ul>
				</div>
			...
			<li class="manager-app-menu-level-0" data-codeform0="RESERVE">
				...
				<ul class="nav nav-second-level collapse " style="">
					...
					<li class="manager-app-menu-level-2" data-codeform0="RESERVE" data-codeform2="RESERVE_BOARD">
						<a href="/manager/board/counsel.php" target="_self"><i class="fa fa-list"></i> 상담신청</a>
					</li>
				...
				<!-- <li class="manager-app-menu-level-0" data-codeform0="PREORDER">
                        ...
                        <ul class="nav nav-second-level collapse" style="">
							...
							<li class="manager-app-menu-level-2" data-codeform0="PREORDER" data-codeform2="PREORDER_LIST">
								<a href="/manager/auth/preorder.php" target="_self"><i class="fa fa-list"></i>선구매리스트</a>
							</li>
			...
			<?php if ($member['mb_level'] == "10") { ?>
				<!-- <li class="manager-app-menu-level-0" data-codeform0="PREORDER">
                        <a href="#"><i class="fa fa-car"></i> <span class="nav-label">수입차관리</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse" style="">
					
							<li class="manager-app-menu-level-1">
								<a href="javascript:void(0);"><span class="text-info">할인관리</span></a>
							</li>
					
							<li class="manager-app-menu-level-2" data-codeform0="PREORDER" data-codeform2="PREORDER_LIST">
								<a href="/manager/imcar/discount.php" target="_self"><i class="fa fa-list"></i>할인리스트</a>
							</li>
							<li class="manager-app-menu-level-1">
								<a href="javascript:void(0);"><span class="text-info">재고관리</span></a>
							</li>
					
							<li class="manager-app-menu-level-2" data-codeform0="PREORDER" data-codeform2="PREORDER_LIST">
								<a href="/manager/imcar/imList.php" target="_self"><i class="fa fa-list"></i>재고리스트</a>
							</li>
			...
			<?php if ($member['mb_level'] == "10") { ?>
				<!-- <li class="manager-app-menu-level-0" data-codeform0="SYSTEM">
					<a href="#"><i class="fa fa-cogs"></i> <span class="nav-label">수수료 관리 </span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse" style="">
						...
						<li class="manager-app-menu-level-2" data-codeform0="SYSTEM" data-codeform2="SYS_ROCG">
							<a href="/manager/auth/rocG.php" target="_self"><i class="fa fa-calculator"></i>일반구매</a>
						</li>
													
							<li class="manager-app-menu-level-2" data-codeform0="SYSTEM" data-codeform2="SYS_ROCP">
								<a href="/manager/auth/rocP.php" target="_self"><i class="fa fa-money"></i>선구매</a>
							</li> -->
						<?php /*
							<li class="manager-app-menu-level-1">

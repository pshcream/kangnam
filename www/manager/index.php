...
$total_res = sql_fetch("select count(*) as cnt from {$g5['dbadmin_application_table']} ");
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="feed-activity-list">
                                    ...
                                    $sql = "select * from {$g5['dbadmin_application_table']} where 1 order by wr_id desc limit 0, 10";
                                    $qry = sql_query($sql);

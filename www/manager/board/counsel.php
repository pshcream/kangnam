...
// 접근 권한 검사
if (!$member['mb_id']) {
    alert('로그인 하십시오.', G5_DBADMIN_ADMIN_URL . '/login.php?url=' . urlencode(correct_goto_url(G5_DBADMIN_ADMIN_URL)));
}
...
include_once(G5_DBADMIN_ADMIN_PATH . '/functions.php');
...
$total_res = sql_fetch("select count(*) as cnt from {$g5['dbadmin_application_table']} where 1 $sql_group $sql_search");
...
//출고
$res = sql_fetch("select count(*) as cnt from {$g5['dbadmin_application_table']} where lo_cus_name!='' $sql_group $sql_search");
$cnt1 = $res['cnt'];

$res = sql_fetch("select count(*) as cnt from {$g5['dbadmin_application_table']} where lo_cus_name='' $sql_group $sql_search");
$nonpre_count = $res['cnt'];

$res = sql_fetch("select count(*) as cnt from {$g5['dbadmin_application_table']} where lo_expose='N' $sql_group $sql_search");
$hid_count = $res['cnt'];
...
<head>
    ...
    <title>D.FORMULA DB 관리자 페이지</title>
...
<body>
    <div id="wrapper">
        ...
        <!-- NAV s -->
        <?php include_once(G5_DBADMIN_ADMIN_PATH . '/navi.inc.php'); ?>
        <!-- NAV e -->
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li>
                            <a href="<?php echo G5_DBADMIN_ADMIN_URL ?>/logout.php?url=<?php echo urlencode(correct_goto_url("/" . G5_DBADMIN_ADMIN_DIR)); ?>">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "select * from {$g5['dbadmin_application_table']} where 1 $sql_group $sql_search order by wr_id desc limit $page_start, $page_size";
                                                $qry = sql_query($sql);
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $res['wr_1']; ?></td>
                                                        ...
                                                        <td class="text-center" style="width: 20%;"><?php echo hyphen_hp_number(get_text($res['wr_content'])); ?></td>
    ...
    <script type="text/javascript">
        ...
        function fn_regist() {
            document.location.href = "/manager/board/counsel_write.php";
        }
    </script>

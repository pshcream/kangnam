...
$total_res = sql_fetch("select count(*) as cnt from {$g5['chadeal_car_preordered_table']} where 1 $sql_group $sql_search");
...
<head>
	...
	<script src="/chadeal_adm/js/rchada.js"></script>
...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0)">수입차관리</a>
						</li>
						<li class="active">
							<strong>수입차 재고리스트 관리</strong>
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-14">
						...
						<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
							...
							<input type="hidden" name="chadeal_id" value="<?php echo $chadeal_id ?>">
							...
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content m-b-sm border-bottom">
									<div class="row">
										<div class="col-sm-2">
											<div class="form-group">
												...
												<select name="brn" id="brn" class="form-control" size="7">
										...
										<div class="col-sm-2">
											<div class="form-group">
												...
												<select name="modl" id="modl" class="form-control" size="7">
										...
										<div class="col-sm-5">
											<div class="form-group">
												...
												<select name="trim" id="trim" class="form-control" size="7">
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<select name="dtl_trim" id="dtl_trim" class="form-control" size="7">
									...
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label class="control-label" for="ext_color">외장색상</label>
												<select name="ext_color" id="ext_color" class="form-control" size="5">
													<option value="other">직접입력</option>
												</select>
                                                <input type="text" class="otherInput ext_color form-control input-sm" id="otherInput_ext_color" name="otherInput_ext_color" style="display:none;">
                                                <button type="button" class="cancelButton ext_color" id="cancelButton_ext_color" style="display:none;" onclick="onCancel('ext_color')">x</button>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												<label class="control-label" for="int_color">내장색상</label>
												<select name="int_color" id="int_color" class="form-control" size="5">
													<option value="other">직접입력</option>
												</select>
                                                <input type="text" class="form-control input-sm" id="otherInput_int_color" name="otherInput_int_color" style="display:none;" value="" />
                                                <button type="button" class="" id="cancelButton_int_color" style="display:none;" onclick="onCancel('int_color')">x</button>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-sm-2">
											<div class="form-group">
                                                ...
                                                <select name="releaseType" id="releaseType" class="form-control" size="5">
										...
										<div class="col-sm-1">
											<div class="form-group">
												<label class="control-label" for="capitalNm">업체명</label>
                                                <select name="capitalNm" id="capitalNm" class="form-control" size="5">
                                                    <?php echo getcapitalNm(); ?>
                                                </select>
											</div>
										</div>
                                        <div class="col-sm-1">
											<div class="form-group">
												...
												<select name="specialExcise" id="specialExcise" class="form-control" size="5">
										...
										<div class="col-sm-1">
											<div class="form-group">
												...
												<select name="stockType" id="stockType" class="form-control" size="5">
										...
										<div class="col-sm-1">
											<div class="form-group">
												...
												<select name="orderDateNm" id="orderDateNm" class="form-control" size="5">
										...
										<div class="col-sm-1">
											<div class="form-group">
												<label class="control-label" for="orderAmount">출고대수</label>
						...
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5><i class="fa fa-file"></i> 선구매리스트 (총<?php echo $total_count; ?>대) <small>선구매 차량의 정보를 관리합니다.</small></h5>
							</div>
									...
									<table class="table table-striped table-hover">
										<thead>
											<tr>
												...
												<th class="text-center">상세트림<br/>차량가격<br/>개소세</th>
												<th class="text-center">옵션</th>
												<th class="text-center">외장색상</th>
												<th class="text-center">내장색상</th>
												<th class="text-center">업체명<br />출고구분</th>
												<th class="text-center">등록일<br />예정일</th>
										...
										<tbody>
											...
											$sql = "select * from {$g5['chadeal_car_preordered_table']} where 1 $sql_group $sql_search order by chadeal_id desc limit $page_start, $page_size";
											$qry = sql_query($sql);
											$no = 1;
											...
											?>
												...
												<tr>
													<td class="text-center"><?php echo $res['brnNm']; ?></td>
													<td class="text-center"><?php echo $res['modlNm']; ?></td>
													<td class="text-center"><?php echo $res['trimNm']; ?></td>
													<td class="text-center"><?php echo $res['dtlTrimNm']; ?><br/><?php echo "₩".number_format($res['pretaxPrice']); ?><br />(<?php echo ($res['specialExcise'] * 100); ?>%)</td>
													...
													<td class="text-center"><?php echo $res['capitalNm'] ?><br/><?php echo $res['releaseType']; ?></td>
													<td class="text-center"><?php echo $res['chadeal_datetime']; ?><br /><?php echo $res['orderDateNm']; ?></td>
													...
													<td class="text-center">
														...
														<button type="button" class="btn btn-danger btn-sm" onclick="fn_del('<?php echo $res['chadeal_id'] ?>')"><i class="fa fa-trash"></i> 삭제</button>
													</td>
												</tr>
												<tr>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			$ext_color = $("#ext_color");
			$int_color = $("#int_color");
			$otherInput_int_color = $("#otherInput_int_color");
			$options = $("#options");
			$car_price = $("#car_price");
			$opt_price = $("#opt_price");
			$tot_price = $("#tot_price");
		...
		function chgDTLTRIM(_dtl_trim, selectedOpions = false, selectedColor = false, selectedInnerColor = false) {
			...
			jQuery.ajax({
				...
				success: function(msg) {
                    ...
                    console.log(msg.innerColors.length);
                    ...
                    if (msg.innerColors.length == 0){
                        const colorSelect = document.getElementById("int_color");
                        const otherInput = document.getElementById("otherInput_int_color");
                        const cancelButton = document.getElementById("cancelButton_int_color");
		...
		function resetOptCol() {
			...
			$('<option>').text("직접입력").val("other").attr("data-price", 0).appendTo($ext_color);
			$('<option>').text("직접입력").val("other").appendTo($int_color);
		}
        ...
        function onChange(status) {
            const colorSelect = document.getElementById(status);
            const otherInput = document.getElementById("otherInput_"+status);
            const cancelButton = document.getElementById("cancelButton_"+status);
		...
		function fn_save() {
			...
			if (document.getElementById("capitalNm").value == "") {
				alert("업체명을 선택해 주세요.");
				document.getElementById("capitalNm").focus();
				return false;
			}		
			...
			$.ajax({
				url: "<?php echo G5_CHADEAL_ADMIN_AUTH_URL; ?>/ajax.preorder_save.php",
				...
				success: function(data) {
					...
					if (data > 0) {
						...
						//reset
						document.location.replace("<?php echo G5_CHADEAL_ADMIN_AUTH_URL; ?>/preorder.php");
					}
				}
			}); //ajax
			return false;

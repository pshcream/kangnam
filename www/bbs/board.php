...
if ((isset($wr_id) && $wr_id) || (isset($wr_seo_title) && $wr_seo_title)) {
    ...
    $g5['title'] = strip_tags(conv_subject($write['wr_subject'], 255)) . "(" . $write['wr_5'] . " " . $write['wr_6'] . " " . $write['wr_7'] . " " . $write['wr_1'] . " " . $write['wr_2'] . ") > " . $g5['board_title'];
    $g5['board_description'] = strip_tags(conv_subject($write['wr_content'], 255));
} else {

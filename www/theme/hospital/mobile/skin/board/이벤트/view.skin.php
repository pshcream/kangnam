    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="/minandmin-introduction/hospital-introduction/" class="">민앤민소개</a>
            </div>
            <div class="swiper-slide">
                <a href="/lifting-clinic/botox/" class="">리프팅클리닉</a>
            </div>
            <div class="swiper-slide">
                <a href="/skin-clinic/pigment-care/" class="">스킨클리닉</a>
            </div>
            <div class="swiper-slide">
                <a href="/allergy-clinic/atopy/" class="">알레르기클리닉</a>
            </div>
            <div class="swiper-slide">
                <a href="/immune-clinic/chronic-allergy-test/" class="">면역클리닉</a>
            </div>
            <div class="swiper-slide">
                <a href="/scar-clinic/burn-and-burn-scar/" class="">흉터클리닉</a>
            </div>
            <div class="swiper-slide">
                <a href="/recommended-treatment-by-age-and-gender/recommended-treatment-for-women-in-their-30s/botox/" class="">연령별/성별추천시술</a>
            </div>
            <div class="swiper-slide">
...
function get_view_thumbnail_a($contents, $thumb_width=0)
{
    global $board, $config;
     ...
     echo($img_tag);
        ...
        if ($v_img_count) {
            ...
            for ($i = 0; $i <= count($view['file']); $i++) {
                echo get_view_thumbnail_a($view['file'][$i]['view']);
            }
            echo "</div>\n";
        }
        ?>

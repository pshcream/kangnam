    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="/all-liting-introduction/about-lifting-center/" class="">올리팅소개</a>
            </div>
            <div class="swiper-slide">
                <a href="/need-for-lifting/causes-and-process-of-facial-wrinkles-and-sagging/" class="">리프팅필요성</a>
            </div>
            <div class="swiper-slide">
                <a href="/one-day-lfting/ulthera/" class="">원데이리프팅</a>
            </div>
            <div class="swiper-slide">
                <a href="/neck-wrinkle-lifting/main/" class="">목주름리프팅</a>
            </div>
            <div class="swiper-slide">
                <a href="/one-day-facial-shaping/botox/" class="">원데이페이셜쉐이핑</a>
            </div>
            <div class="swiper-slide">
                <a href="/surgical-lifting/mint-thread-lifting/" class="">수술리프팅</a>
            </div>
            <div class="swiper-slide">
                <a href="/skinbooster/filorga135/" class="">스킨부스터</a>
            </div>
            <div class="swiper-slide">
                <a href="/anti-aging-and-inner-beauty/main/" class="">항노화/이너뷰티</a>
            </div>
...
<form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
    ...
    <?php if ($rss_href || $write_href) { ?>
        <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top top btn_bo_user'; ?>">
            ...
            <?php } ?>
            <?php if ($write_href) { ?>
                <li><a href="<?php echo $write_href ?>" class="fix_btn write_btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li>
                <li><a href="<?php echo $write_href ?>&mutipleUplad" style="bottom: 120px;" class="fix_btn write_btn" title="멀티업로드"><i class="fa fa-upload" aria-hidden="true"></i><span class="sound_only">멀티이미지 업로드</span></a></li>
            <?php } ?>
        </ul>
    <?php } ?>

...
<div class="sub_nav mobile">
    <div class="nav_select">
        <select onchange="window.open(value,'_self');">
            <option value="/consult" selected="selected">온라인상담</option>
            <option value="/jisikin">생활건강지식in</option>
    ...
    <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div id="bo_btn_top">
            <div id="bo_list_total">
                <span>총 <?php echo number_format($total_count) ?>건의 글이 등록되었습니다.</span>
                <!--<?php echo $page ?> 페이지-->
            </div>
            ...
            <?php if ($rss_href || $write_href) { ?>
                <ul class="btn_bo_user">
                    ...
                    <!--
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i>글쓰기<span class="sound_only">글쓰기</span></a></li><?php } ?>
            -->

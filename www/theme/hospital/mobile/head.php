...
<header id="hd">
  ...
  <div id="hd_wrapper">
    ...
    <a href="tel:02-3477-9924" class="phone_menu">
      <img class="color_phone on" src="/theme/hospital/img/mobile/phone_menu.png" alt="">
      <img class="white_phone on" src="https://dformula.speedgabia.com/_formulaclinic/mobile/phone_menu_white.png" alt="">
    </a>
    <button type="button" id="gnb_open" class="hd_opener"><img src="/theme/hospital/img/mobile/hamburger_logo.png">

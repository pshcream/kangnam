...
<div class="mobile_quick on">
  ...
  <a href="https://pf.kakao.com/_iuzxbu/chat" target="_blank" class="quickM kakao"></a>
  <a href="https://www.instagram.com/lifehealthbs_diet/" target="_blank" class="quickM instagram"></a>
...
<div class="" style="">
<form method="post" name="newftFrm" id="gform" data-email="dodreamdb@gmail.com" action="https://script.google.com/macros/s/AKfycbxMQEPoDsaGBvBPk2n5n13LxDPQ6SUU7aAVNkJ8uBtAeDsN5sjGv4kg9DHajCh24bVs/exec" class="gform">
...
<div id="ft">
  ...
  <div class="foot_sns_wrap">
    <div class="foot_sns">
      ...
      <a href="https://www.instagram.com/jiseung.korean.medical.clinic/" target="_blank"><img src="https://dformula.speedgabia.com/_formula/mobile/float_instagram.png" alt="" loading="lazy"></a>
  ...
  <div class="footerm">
    ...
    <div class="address">
      <p class="address_txt">부산광역시 부산진구 중앙대로691번길 5, 4층(부전동) </p>
      <div>
        <p class="infoDesc">
          의료기관명칭:생활건강한의원 | 대표원장:고창현 | 사업자등록번호:510-92-00254<br>
        </p>
      </div>
      <p class="last">COPYRIGHT ⓒ 2022 LIFEHEALTH.CO.KR<br>ALL RIGHT PRESERVED</p>
    </div>
  </div>
  <!--기타 푸터 끝-->
  <!--

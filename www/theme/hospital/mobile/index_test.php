      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          <div class="surgery_type">
            ...
            <p class="content">생활건강한의원의 정밀한 진단으로 원인과 피부 상태에 따라 복합적인 맞춤치료</p>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="surgery_type">
            ...
            <p class="name">여드름</p>
            <p class="content">생활건강한의원의 개인별 1:1 맞춤 진료로 원인부터 해결하고 재발을 억제하는 여드름 치료</p>
          </div>
          <a href="/skincare/acne-blush.php" class="link_button">+</a>
          <div class="dark_cover"></div>
        </div>

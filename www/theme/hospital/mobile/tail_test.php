...
<div class="mobile_quick on">
  ...
  <a href="https://pf.kakao.com/_Jxfdcb/chat" target="_blank" class="quickM kakao"></a>
  <a href="https://www.instagram.com/ps.dr.hyo/" target="_blank" class="quickM instagram"></a>
...
<script>
  function showPopup() {
    window.open("http://theolimclinic.com/popup.php", "a", "width=450, height=300, left=350, top=80"); {
...
<div class="" style="">
  <form method="post" name="newftFrm" id="gform" data-email="dodreamdb@gmail.com" action="https://script.google.com/macros/s/AKfycbyPH2n7ls9vMau3TvnQ-OLDM-OPWho5Ns_kx4VroA/exec" class="gform">
        ...
        <div class="btnWrap">
          <p class="fixedType">
            <select id="fn_type" name="u_type" required>
              ...
              <option value="리프팅수술">리프팅수술</option>
              <option value="기타수술">기타수술</option>
              <option value="레이저시술">레이저시술</option>
              <option value="주사시술">주사시술</option>
              <option value="실리프팅시술">실리프팅시술</option>
...
<div id="ft">
  ...
  <div class="foot_sns_wrap">
    <div class="foot_sns">
      ...
      <a href="https://www.instagram.com/ps.dr.hyo/" target="_blank"><img src="https://dformula.speedgabia.com/_formula/mobile/float_instagram.png" alt="" loading="lazy"></a>
      <a href="https://pf.kakao.com/_Jxfdcb/chat" target="_blank"><img src="https://dformula.speedgabia.com/_formula/mobile/float_kakao.png" alt="" loading="lazy"></a>
  ...
  <div class="footerm">
    ...
    <div class="family_site">
      <a href="https://formulahairplant.com/" target="_blank">
        <img src="https://dformula.speedgabia.com/_alllitinglifting/link_ps.gif" alt="" loading="lazy">
      </a>
    </div>
    <div class="privacy">
      <ul>
    ...
    <div class="address">
      ...
      <p class="last">COPYRIGHT ⓒ 2022 FORMULALIFTINGCLINIC.COM<br>ALL RIGHT PRESERVED</p>
    </div>
  </div>
  <!--기타 푸터 끝-->
  <!--

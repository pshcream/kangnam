...
<!---전후사진탭시작-->  
 <div class="page">
    ...
    <div class="sub_title" id="start">
      <div class="name"><span>BEFORE&AFTER</span> <b>전후사진</b></div>
      <div class="exp">생활건강에서 시술한 다양한 사례를 볼 수 있습니다</div>
    </div>    
		...
		<li class="on">
			<a href="/bbs/board.php?bo_table=before_after#start">전체</a>
        </li>
			
        <li>
            <a href="/bbs/board.php?bo_table=before_after#start">복부지방흡입</a>
        </li>
        <li>
            <a href="/bbs/board.php?bo_table=before_after#start">허벅지지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after#start">팔뚝지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after#start">종아리지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after">등지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after#start">엉덩이지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after#start">특수부위지방흡입</a>
        </li>
        <li>
            <a href="/bbs/board.php?bo_table=before_after#start">옆테라인지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after">한부위지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after">이중턱지방흡입</a>
        </li>
		
		<li>
            <a href="/bbs/board.php?bo_table=before_after">미니지방흡입</a>
        </li>
		<li>
            <a href="/bbs/board.php?bo_table=before_after">지방흡입재수술</a>
        </li>
		<li style="background:#F5F5F5;">
            <a href="/bbs/board.php?bo_table=before_after">대용량지방흡입</a>
        </li>

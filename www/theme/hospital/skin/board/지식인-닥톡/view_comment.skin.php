...
-->
    ...
    <section id="bo_vc">
        ...
        <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0" <?php } ?>>
          ...
          <div class="cm_wrap">
            ...
            <?php if ($is_admin) { ?>
              ...
              <header style="z-index:<?php echo $cmt_sv; ?>">
                ...
                <span class="bo_vc_hdinfo">
                  ...
                  <time datetime="<?php echo date('Y-m-d\TH:i:s+09:00:00', strtotime($list[$i]['datetime'])) ?>">
            ...
            <div class="cmt_contents">
              ...
              <div class="jisik_reply_name">
                <img src="/theme/hospital/img/logo.png" alt="">
                <h1>님 답변</h1>
              </div>
          ...
          <?php if ($is_comment_reply_edit) { ?>
            ...
            <?php if ($is_admin) { ?>
              <!--  -->
              <div class="edit_q edit_a">
                <?php if ($list[$i]['is_edit']) { ?><li><a href="<?php echo $c_edit_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;">수정 <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li></a></li><?php } ?>
      ...
      <?php } ?>
      <?php if ($i == 0) { //댓글이 없다면 
      ?><p id="bo_vc_empty">등록된 답변이 없습니다.</p><?php } ?>

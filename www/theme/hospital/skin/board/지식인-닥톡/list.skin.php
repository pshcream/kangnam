...
<title>생활건강지식인 - 상담예약 | 포뮬라의원 만성질환클리닉</title>
    ...
    color: #f4f4f4;">
                    ...
                    <div style="width: 620px; display: inline-block;">
                      ...
                      <div class="kin_content">
                        ...
                        <em class="listCont" id="listCont<?php echo $list[$i]['wr_id'] ?>"><?php echo strip_tags($list[$i]['wr_content']) ?></em>
                        <!-- <em class="listCont" id="listCont<?php echo $list[$i]['wr_id'] ?>"><?php echo strip_tags($list[$i]['content']) ?></em> -->
          ...
          (function(i) {
            ...
            $.ajax({
              ...
              success: function(response, textStatus, xhr) {
                ...
                if (response.header.code == '0000') { // 성공시




                  if (response.body.dtRegisteredYn == 'Y') { // 닥톡 업로드 성공시
                    doctalkUp.innerHTML = "O";
                  } else {
                    doctalkUp.innerHTML = "X";

                  }
                  if (response.body.kinRegisteredYn == 'Y') { // 지식인 업로드 성공시

...
<div class="page">
    <div class="sub">
        <div class="sub_title">
            <div class="name"><span>LIFE HEALTH EVENT</span> <b>생활건강 이벤트</b></div>
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            ...
            <div class="gall_box">
                ...
                <div class="gall_con" onclick="window.open('<?php echo $list[$i]['href'] ?>')" style="corsor:pointer;" >
                    ...
                    <div style="margin-top:10px;">
                        <!--
						<a href="<?php echo $list[$i]['href'] ?>" class="bo_tit" style="font-size:14px" target="_blank">
                        -->

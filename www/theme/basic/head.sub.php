...
<![endif]-->
  ...
  <script type="application/ld+json">
    {
      ...
      "sameAs": ["https://hgkmc1.modoo.at/"]
    }
  </script>
  <!-- 6. 파비콘 -->
  <link rel="shortcut icon" href="./img/favicon_144.png" type="image/x-icon" />
  <link rel="icon" href="./img/favicon_144.png" />
  <!-- For iPhone -->
  ...
  <meta property="og:image" content="https://dformula.speedgabia.com/_alllitingps/og_image.png" />
  <!-- 8. css -->
  <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/moonspam/NanumSquare@1.0/nanumsquare.css">
  <link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/npm/xeicon@2.3.3/xeicon.min.css">
  <link rel="stylesheet" href="https://dodreambodyclinic.com/theme/basic/css/swiper.css">
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://alllitingps.com/theme/basic/css/font.css">
  <!-- 9. javascript -->
  <script type="text/javascript" src="https://dodreamhairplant.co.kr/theme/basic/js/main_swiper.js"></script>
  <!-- 10. 메타태그 네이버/구글 -->
  <meta name="google-site-verification" content="WZmFCYoy4rAeiUtI7oRUde-awTu7sGyp3QnoqKHhM3I" />
  <meta name="naver-site-verification" content="bc00296631e751d1f93bd29c8c728ab756f68acb" />
  <!-- 11. 메타태그 twitter -->
  <meta name="twitter:image" content="https://dformula.speedgabia.com/_alllitingps/og_image.png">
  <meta name="twitter:domain" content="https://alllitingps.com/">
  <!-- 12. 스마트폰상단바색상 -->
  <!-- Chrome, Firefox, Opera -->
  <meta content='#472B33' name='theme-color' />
  <!-- Windows Phone -->
  <meta content='#472B33' name='msapplication-navbutton-color' />
  <!-- iOS Safari -->
  <meta content='#472B33' name='apple-mobile-web-app-status-bar-style' />

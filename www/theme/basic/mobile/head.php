...
<style>
  ...
  #gnb_close i.fa.fa-times::before {
    content: url(https://dformula.speedgabia.com/_dodreamhairplant/new_close_btn.png);
  }
  ...
  <div id="hd_wrapper">
    ...
    <div id="logo">
      <a href="<?php echo G5_URL ?>">
        <img src="/theme/hospital/img/logo.svg" alt="<?php echo $config['cf_title']; ?>">
        <!-- <img src="https://dformula.speedgabia.com/_formulaclinic/mobile/footM_logo.svg" alt="<?php echo $config['cf_title']; ?>"> -->
      </a>
    </div>
    <div class="black_bg"></div>
    <a href="tel:02-3477-9924" class="phone_menu">
      <img class="color_phone on" src="https://dformula.speedgabia.com/_alllitingps/mobile/phone_menu.png" alt="">
      <img class="white_phone on" src="https://dformula.speedgabia.com/_formulaclinic/mobile/phone_menu_white.png" alt="">
    </a>
    <button type="button" id="gnb_open" class="hd_opener"><img src="https://dformula.speedgabia.com/_alllitingps/mobile/hamburger_logo.png">
    ...
    <div id="gnb" class="hd_div">
      ...
      <ul id="hd_nb">
        ...
        <li class="hd_nb3"><a href="<?php echo G5_BBS_URL ?>/current_connect.php" id="snb_cnt"><i class="fa fa-users" aria-hidden="true"></i>접속자 <span><?php echo connect('theme/basic'); // 현재 접속자수 
                                                                                                                                                        ?></span></a></li>

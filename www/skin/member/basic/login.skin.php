...
<div class="login_wrap">
    <div class="login_tit"><span>LOGIN</span>: 회원전용서비스</div>
    <div class="login_subtit">로그인 후 확인하실 수 있습니다.</div>
    <div class="login_txt">아이디와 비밀번호를 입력해주세요.<br>아직 회원이 아니신 분들은 회원가입 후 서비스를 이용하실 수 있습니다.</div>
</div>

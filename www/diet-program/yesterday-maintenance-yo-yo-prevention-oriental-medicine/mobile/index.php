...
<div id="" class="submenu_slider">
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="/diet-program/life-health-diet/" class="">생활건강다이어트</a>
            </div>
            <div class="swiper-slide">
                <a href="/diet-program/today-weight-loss-premium-oriental-medicine/" class="">오늘,감량프리미엄한약</a>
            </div>
            <div class="swiper-slide on">
                <a href="/diet-program/yesterday-maintenance-yo-yo-prevention-oriental-medicine/" class="">내일,유지요요방지한약</a>
            </div>
        </div>
    </div>
</div>
